        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Nama Situs</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Slogan</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Judul Meta</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Deskripsi Meta</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Judul Hero</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Subjudul Hero</label>
                    ...
                    <div class="sm:max-w-xs">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Teks CTA Hero</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Deskripsi Footer</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Alamat Footer</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Email Footer</label>
                        ...
                        <label class="mt-4 text-xs font-semibold text-slate-500 dark:text-slate-300">Telepon Footer</label>
                        ...
                        <label class="mt-4 text-xs font-semibold text-slate-500 dark:text-slate-300">Hak Cipta Footer</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Instagram</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">WhatsApp</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">YouTube</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">TikTok</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div class="mt-4 grid gap-4">
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Embed Peta Kontak</label>
                    ...
                    <div class="sm:max-w-sm">
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Email Penerima Form</label>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <h2 class="text-lg font-semibold text-slate-900 dark:text-white">Kontrol Tipografi & Gaya</h2>
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-300">
                    Kontrol ini akan mempengaruhi gaya teks utama di web pengguna/admin: warna heading, ketebalan font, miring, dan skala ukuran.
                </p>
                <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Warna Teks Isi</label>
                        <input
                            type="color"
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Bobot Heading</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Bobot Teks Isi</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Gaya Heading</label>
                        <select name="typography_heading_style" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700">
                            @foreach (['normal' => 'Normal', 'italic' => 'Miring'] as $value => $label)
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Gaya Teks Isi</label>
                    ...
                    <div>
                        <label class="text-xs font-semibold text-slate-500 dark:text-slate-300">Skala Ukuran Teks Isi</label>
