...
@section('content')
    <main class="bg-[#0A0A0B] text-[#E8E8EC]">
        <section class="relative min-h-screen overflow-hidden">
            ...
            <div class="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 pb-14 pt-28 md:px-10">
                <div class="max-w-3xl">
                    <div class="inline-flex items-center gap-2 rounded-md border border-[#D4A843]/35 bg-black/25 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-[#D4A843] backdrop-blur-sm">
                ...
                <div class="mt-auto pb-2 pt-14 text-center text-[11px] font-semibold uppercase tracking-[0.32em] text-[#A0A0A8]/75">
                    Gulir
                </div>
            </div>
        </section>
