...
<head>
    ...
    <title>Kode OTP Verifikasi Telepon - Manake</title>
</head>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding-top:10px; font-size:15px; line-height:1.7; color:#d8e4ff;">
                                                    Halo {{ $recipientName }}, gunakan kode OTP di bawah ini untuk memverifikasi nomor telepon <strong>{{ $phone }}</strong> Anda pada akun Manake.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:0;">
                                            <tr>
                                                <td style="padding:16px 18px; border:1px solid #e2eaf7; border-radius:20px; background:#f8fbff; font-size:13px; line-height:1.7; color:#5a6f8f;">
                                                    Mode Demo / Sidang TA: Kode OTP ini dikirim via email untuk keamanan tambahan tanpa menggunakan provider SMS pihak ketiga.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
